...
let age = 20;
character={characterName: "Arya", 'character-age': age};
...
character.greet=`I am ${character.characterName} and my title is ${character.title}`;
...
//  - Change the method `greet` to now alert `She is [NAME HERE] and her title is [TITLE HERE]`.
    alert(character.greet=`She is ${character.characterName} and her title is ${character.title}`);
...
character.changeIsAdult=(age)=>{ age= +prompt("Enter age"); return character.isAdult= age>18?true:false };
